...
namespace Pulsar4X.Damage
{
    ...
    {
        public (ArmorBlueprint armorType, float thickness) Armor;
        /// <summary>
        ...
        public EntityDamageProfileDB(List<(ComponentDesign component, int count)> components, (ArmorBlueprint armorSD, float thickness) armor)
        {
            Init(components, armor);
        }
        ...
        private void Init(List<(ComponentDesign component, int count)> components, (ArmorBlueprint armorSD, float thickness) armor)
        {
            ...
            foreach (var componenttype in components)
            {
                ...
                string typeGuid = componenttype.component.UniqueID;
