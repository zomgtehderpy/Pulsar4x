...
namespace Pulsar4X.Storage
{
    public class RemoveComponentFromStorageOrder : EntityCommand
    {
        ...
        internal RemoveComponentFromStorageOrder(Entity entity, ComponentInstance componentInstance, int amount = 1)
        {
        ...
        public static RemoveComponentFromStorageOrder Create(Entity entity, ComponentInstance componentInstance, int amount = 1)
        {
            var cmd = new RemoveComponentFromStorageOrder(entity, componentInstance, amount)
            {
        ...
        {
            CargoTransferProcessor.RemoveCargoItems(EntityCommanding, ComponentInstance, Amount);
            hasExecuted = true;
        }
