...
namespace Pulsar4X.SDL2UI
{
    ...
    public class OverViewPannel
    {
        ...
        {
            EntityInfoWindow.AbilitesDisplay.Display(selectedEntity.Entity);
        }
    }
    ...
    public class FacilitiesViewPannel
    {
        ...
        public static void Display(EntityState selectedEntity)
        {
            ...
            var componentInstances = EntityInfoWindow.ComponentsDisplay.CreateNewInstanceArray(selectedEntity.Entity);
            EntityInfoWindow.ComponentsDisplay.DisplayComplex(componentInstances);
        }
    }
}
